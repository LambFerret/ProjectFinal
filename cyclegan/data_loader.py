...
class DataLoader():
    ...
    def load_data(self, domain, batch_size=1, is_testing=False):
        ...
        path = glob('./drive/MyDrive/datasets/%s/%s/*' % (self.dataset_name, data_type))
    ...
    def load_batch(self, batch_size=1, is_testing=False):
        ...
        path_A = glob('./drive/MyDrive/datasets/%s/%sA/*' % (self.dataset_name, data_type))
        path_B = glob('./drive/MyDrive/datasets/%s/%sB/*' % (self.dataset_name, data_type))
